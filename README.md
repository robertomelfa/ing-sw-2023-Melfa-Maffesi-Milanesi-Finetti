...
- The Client can be run with the following command:
    ...
    > java -jar Client.jar
    ```
    - **IMPORTANT**: before starting the client is important to create two new folders (MyShelfie\saves) in the same directory of jar files. The game files will be saved in this folder.
